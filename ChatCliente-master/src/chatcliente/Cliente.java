...
public class Cliente extends Thread {
    ...
    private final VCliente ventana;
    ...
    Cliente(VCliente ventana, String host, Integer puerto, String nombre) {
    ...
    public void run() {
        try {
            ...
            JOptionPane.showMessageDialog(ventana, "Conexión perdida, servidor desconocido,\n"
                    + "ingresaste una ip incorrecta, intente nuevamente\n"
                    + "Esta aplicación se cerrará.");
            System.exit(0);
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(ventana, "Conexión perdida, error de Entrada/Salida,\n"
                    + "puede que haya ingresado una ip o un puerto incorrecto\n"
                    + "Esta aplicación se cerrará.");
            System.exit(0);
        }
